  ...
  <div>
    ...
    <section class="relative bg-gradient-to-br from-primary-900 via-primary-800 to-primary-700 text-white overflow-hidden">
      ...
      <div class="absolute inset-0 opacity-5">
        <div class="w-full h-full" style="background-image: url('data:image/svg+xml;charset=utf-8,%3Csvg width=%2260%22 height=%2260%22 viewBox=%220 0 60 60%22 xmlns=%22http://www.w3.org/2000/svg%22%3E%3Cg fill=%22none%22 fill-rule=%22evenodd%22%3E%3Cg fill=%22%23ffffff%22 fill-opacity=%220.4%22%3E%3Ccircle cx=%2230%22 cy=%2230%22 r=%222%22/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')"></div>
      </div>
      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div class="animate-fade-in text-center lg:text-left">
            <div class="inline-flex items-center px-4 py-2 bg-taxi-yellow/20 border border-taxi-yellow/30 rounded-full text-taxi-yellow text-sm font-medium mb-6">
              <span class="w-2 h-2 bg-taxi-yellow rounded-full mr-2 animate-pulse"></span>
              Service 24h/24 - 7j/7
            </div>
            
            <h1 class="text-3xl sm:text-4xl lg:text-6xl font-bold mb-6 animate-slide-up leading-tight">
          ...
          <div class="relative animate-fade-in" style="animation-delay: 0.6s">
            <div class="relative w-full h-96 lg:h-[500px] rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div class="absolute bottom-4 left-4 z-20 text-white">
                <div class="text-sm font-medium">📍 Les Sables d'Olonne</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          <div 
            ...
            :key="service.title"
            class="group bg-white rounded-2xl p-6 sm:p-8 border border-gray-100 hover:border-primary-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 text-center"
            :class="`animate-slide-up`"
            :style="`animation-delay: ${index * 0.1}s`"
          >
            <div class="w-16 h-16 bg-gradient-to-br from-primary-500 to-primary-600 rounded-2xl flex items-center justify-center text-2xl mb-6 group-hover:scale-110 transition-transform duration-300 mx-auto">
              {{ service.icon }}
            </div>
    ...
    <section class="py-20 bg-gray-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          ...
          >
            <div class="w-16 sm:w-20 h-16 sm:h-20 bg-primary-100 rounded-full flex items-center justify-center text-2xl sm:text-3xl mx-auto mb-4 sm:mb-6">
              {{ advantage.icon }}
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          ...
          <div class="bg-gradient-to-br from-red-50 to-pink-50 rounded-xl p-4 sm:p-6 text-center">
            ...
            <ul class="text-xs sm:text-sm text-gray-700 space-y-1">
              ...
              <li>• Transport conventionné CPAM</li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <section class="py-20 bg-gray-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          <div class="bg-white rounded-xl p-4 sm:p-6 shadow-lg text-center">
    ...
    <section class="py-12 sm:py-16 bg-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="max-w-4xl mx-auto text-gray-700 leading-relaxed px-4">
          ...
          <p class="mb-4 sm:mb-6 text-sm sm:text-base">
            Spécialisés dans le <strong>transport médical conventionné</strong>, nos chauffeurs professionnels vous accompagnent vers les établissements de santé avec prise en charge <strong>CPAM</strong>. Service de <strong>taxi gare SNCF Les Sables d'Olonne</strong> et transferts <strong>aéroport Nantes</strong> avec suivi des horaires en temps réel.
          </p>
          <p class="text-sm sm:text-base">
            Courses locales <strong>Olonne-sur-Mer</strong>, <strong>Château d'Olonne</strong>, <strong>La Chaume</strong> et longues distances vers <strong>La Roche-sur-Yon</strong>, <strong>Nantes</strong>, <strong>Challans</strong>. Tarifs réglementés Vendée, véhicules climatisés, réservation par téléphone au <strong>06 68 31 46 90</strong>.
          </p>
        </div>
      </div>
    </section>
...
const services = [
  {
    icon: '🏙️',
    title: 'Taxi Local Les Sables d\'Olonne',
    description: 'Courses locales aux Sables d\'Olonne, Olonne-sur-Mer, Château d\'Olonne, La Chaume. Service taxi rapide 24h/24 pour vos trajets quotidiens en Vendée.'
  },
  {
    icon: '🚅',
    title: 'Taxi Gare SNCF & Aéroport',
    description: 'Transferts taxi vers gare SNCF Les Sables d\'Olonne, TGV La Roche-sur-Yon et aéroport Nantes. Suivi horaires temps réel, ponctualité garantie.'
  },
  {
    icon: '🏥',
    title: 'Transport Médical Conventionné',
    description: 'Taxi médical agréé CPAM toutes caisses. Transport vers CHD Vendée, cliniques, centres de soins. Facturation directe possible.'
  }
]
...
const advantages = [
  {
    icon: '⏰',
    title: 'Taxi 24h/24 - 7j/7',
    description: 'Service taxi aux Sables d\'Olonne disponible jour et nuit, week-ends et jours fériés. Réservation urgente acceptée.'
  },
  {
    icon: '💰',
    title: 'Tarifs Réglementés Vendée',
    description: 'Tarifs officiels préfecture Vendée. Transport médical conventionné CPAM, Mutuelle. Devis gratuit longues distances.'
  },
  {
    icon: '🌡️',
    title: 'Véhicules Modernes',
    description: 'Flotte taxi récente climatisée. Véhicules adaptés PMR disponibles. Confort garanti courtes et longues distances.'
  }
]

useSeoMeta({
  title: 'Taxi Les Sables d\'Olonne - Service 24h/24 Vendée | 06 68 31 46 90',
  description: 'Taxi Les Sables d\'Olonne ⭐ Service 24h/24 au 06 68 31 46 90. Transport médical conventionné CPAM, gare SNCF, aéroport Nantes. Tarifs réglementés Vendée. Place Napoléon III.',
